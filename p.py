...
load = Image.open("D:/gui/india.png")
...
def math_random():
    ...
    global add_image1
    global add_image2
    card1="D:/gui/flashcards/" + str(num_1) +".png"
    card2="D:/gui/flashcards/" + str(num_2) +".png"
...
def answer_sub():
    ...
    try:
        ...
        messagebox.showerror("Error","Write a value! Not character")    
...
def random_state():
    ...
    state1="D:/gui/states/" + our_states[rando] +".png"
...
def state_capitals():
    ...
    while count <4:
        ...
        if count==1:
            ...
            global state_img
            state="D:/gui/states/"+our_states[rando]+".png"
